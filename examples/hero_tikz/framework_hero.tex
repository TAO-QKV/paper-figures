...
% Paper:  \includegraphics[width=\linewidth]{framework_hero.pdf}
...
\begin{tikzpicture}[
  ...
  \begin{scope}[shift={($(fuse.center)+(0,-1mm)$)}, x=1.5mm, y=1.5mm]
    \draw[blue!70!black, line width=0.6pt] (-7,-3) -- (7,3);        % mech prediction
    \draw[orange!80!black, line width=0.6pt] (-7,3) -- (7,-2.5);    % data prediction
    \draw[red!65, line width=1pt] (-7,0.2) .. controls (0,1.6) .. (7,0.6); % fused
    \node[font=\tiny, text=red!50!black, anchor=south] at (0,1.7) {$\hat y=w\,y_{\mathrm{m}}+(1\!-\!w)y_{\mathrm{d}}$};
  \end{scope}
